...
export default function () {
  try {
    const productCreateForm = selectOne("#product-create-form"),
      ...
      productImagesFileInput = productCreateForm.querySelector(
        "#product-images-file-input"
      ),
      productFeaturesWrapper =
        productCreateForm.querySelector(".product-features"),
      productFeatureAddBtn = productCreateForm.querySelector(
      ...
      secondaryCategorySelect = productCreateForm.querySelector(
        "#secondary-category"
      ),
      tertiaryCategorySelect =
        productCreateForm.querySelector("#tertiary-category"),
      ...
      productDescriptionUz = productCreateForm.querySelector(
        "#product-description-uz"
      ),
      productDescriptionRu = productCreateForm.querySelector(
        "#product-description-ru"
      ),
      productDescriptionEn = productCreateForm.querySelector(
