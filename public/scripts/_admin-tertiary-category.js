...
export default function () {
  try {
    const tertiaryCategoryCreateForm = document.getElementById(
        "tertiary-create-form"
      ),
      tertiaryCategoryImageInput = document.getElementById(
        "tertiary-category-img"
      ),
      tertiaryCategorySelectCategories = document.getElementById(
        "tertiary-select-category"
      ),
      tertiaryCategorySelectSecondaryCategories = document.getElementById(
        "tertiary-select-secondary-category"
      ),
      tertiaryCategoryNameUz = document.getElementById(
        "tertiary-category-name-uz"
      ),
      tertiaryCategoryNameRu = document.getElementById(
        "tertiary-category-name-ru"
      ),
      tertiaryCategoryNameEn = document.getElementById(
        "tertiary-category-name-en"
      );
    ...
    tertiaryCategorySelectCategories.addEventListener("click", async (e) => {
      ...
      if (response.sub_categories.length > 0) {
        ...
        tertiaryCategorySelectSecondaryCategories.setAttribute(
          "disabled",
          "true"
        );
      }
    ...
    tertiaryCategoryCreateForm.addEventListener("submit", async (e) => {
      ...
      formData.append(
        ...
        tertiaryCategoryImageInput.files[0]
      );
      formData.append(
        "sub_category_id",
        tertiaryCategorySelectSecondaryCategories.value
      );
      formData.append(
        "sub_sub_category_name_uz",
        clearText(tertiaryCategoryNameUz.value)
      );
      formData.append(
        "sub_sub_category_name_en",
        clearText(tertiaryCategoryNameEn.value)
      );
      formData.append(
        "sub_sub_category_name_ru",
        clearText(tertiaryCategoryNameRu.value)
      );
    ...
    const removeTertiaryCategoryBtns = selectAll(
      "[data-tertiary-category-remove]"
    );
    ...
    function changeCategorySelect() {
      const categorySelect = selectOne("#tertiary-category-select"),
        secondaryCategorySelect = selectOne(
          "#tertiary-secondary-category-select"
        );
    ...
    function editTertiaryCategoryImage() {
      const tertiaryCategoryEditFileInputs = selectAll(
        '#tertiary-category-edit-form input[type="file"]'
      );
      tertiaryCategoryEditFileInputs.forEach((el) => {
        el.addEventListener("change", (ev) => {
          const tertiaryCategoryImg =
          ...
          if (ev.target.files && ev.target.files[0]) {
            ...
            reader.onload = function (e) {
              if (!tertiaryCategoryImg.children[1]) {
                ...
                tertiaryCategoryImg.children[1].children[0].src =
                  e.target.result;
              }
    ...
    function tertiaryCategoryImgUpdatedRemove() {
      const tertiaryCategoryImgUpdatedVersionRemoveElements = selectAll(
        "#tertiary-category-img-update-version-remove"
      );
      tertiaryCategoryImgUpdatedVersionRemoveElements.forEach((el) => {
        el.addEventListener("click", (e) => {
          const tertiaryCategoryImgFileInput =
    ...
    function editTertiaryCategorySubmit() {
      const editTertiaryCategoryForm = selectOne(
        "#tertiary-category-edit-form"
      );

      editTertiaryCategoryForm.addEventListener("submit", async (e) => {
        e.preventDefault();

        const tertiaryCategoryImgInput = editTertiaryCategoryForm.querySelector(
            "#tertiary-category-img-input"
          ),
          tertiaryCategorySelect = editTertiaryCategoryForm.querySelector(
            "#tertiary-category-select"
          ),
          tertiarySecondaryCategorySelect =
            editTertiaryCategoryForm.querySelector(
              "#tertiary-secondary-category-select"
            ),
          tertiaryCategoryNameUzInput = editTertiaryCategoryForm.querySelector(
            "#tertiary-category-name-uz"
          ),
          tertiaryCategoryNameRuInput = editTertiaryCategoryForm.querySelector(
            "#tertiary-category-name-ru"
          ),
          tertiaryCategoryNameEnInput = editTertiaryCategoryForm.querySelector(
            "#tertiary-category-name-en"
          ),
          tertiaryCategoryEditSubmitBtn =
            editTertiaryCategoryForm.querySelector(".btn-primary");
        ...
        if (tertiaryCategoryImgInput.files[0]) {
          formData.append(
            "sub_sub_category_image",
            tertiaryCategoryImgInput.files[0]
          );
        }

        formData.append(
          "sub_category_id",
          tertiarySecondaryCategorySelect.value
        );
        formData.append(
          "sub_sub_category_name_uz",
          clearText(tertiaryCategoryNameUzInput.value)
        );
        formData.append(
          "sub_sub_category_name_ru",
          clearText(tertiaryCategoryNameRuInput.value)
        );
        formData.append(
          "sub_sub_category_name_en",
          clearText(tertiaryCategoryNameEnInput.value)
        );
        formData.append(
          "sub_sub_category_id",
          tertiaryCategoryEditSubmitBtn.id
        );
        ...
        if (!response.ok) {
          if (
            editTertiaryCategoryForm.children[0].classList.contains(
              "alert-danger"
            )
          ) {
