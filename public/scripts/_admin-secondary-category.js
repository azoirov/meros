...
export default function () {
  try {
    const secondaryCategoryCreateForm = document.getElementById(
        "secondary-category-create-form"
      ),
      secondaryCategoryImageInput = document.getElementById(
        "secondary-category-img"
      ),
      secondaryCategorySelectCategories = document.getElementById(
        "secondary-category-categories"
      ),
      secondaryCategoryNameUz = document.getElementById(
        "secondary-category-name-uz"
      ),
      secondaryCategoryNameRu = document.getElementById(
        "secondary-category-name-ru"
      ),
      secondaryCategoryNameEn = document.getElementById(
        "secondary-category-name-en"
      );
    ...
    secondaryCategoryCreateForm.addEventListener("submit", async (e) => {
      ...
      formData.append(
        "sub_category_image",
        secondaryCategoryImageInput.files[0]
      );
      formData.append("category_id", secondaryCategorySelectCategories.value);
      formData.append(
        "sub_category_name_uz",
        clearText(secondaryCategoryNameUz.value)
      );
      formData.append(
        "sub_category_name_en",
        clearText(secondaryCategoryNameEn.value)
      );
      formData.append(
        "sub_category_name_ru",
        clearText(secondaryCategoryNameRu.value)
      );
    ...
    const removeSecondaryCategoryBtns = selectAll(
      "[data-secondary-category-remove]"
    );
    ...
    const editSecondaryCategoryBtns = selectAll(
      "[data-secondary-category-edit]"
    );
    ...
    function editSecondaryCategoryImage() {
      const secondaryCategoryEditFileInputs = selectAll(
        '#secondary-category-edit-form input[type="file"]'
      );
      secondaryCategoryEditFileInputs.forEach((el) => {
        el.addEventListener("change", (ev) => {
          const secondaryCategoryImg =
          ...
          if (ev.target.files && ev.target.files[0]) {
            ...
            reader.onload = function (e) {
              if (!secondaryCategoryImg.children[1]) {
                ...
                secondaryCategoryImg.children[1].children[0].src =
                  e.target.result;
              }
    ...
    function secondaryCategoryImgUpdatedRemove() {
      const secondaryCategoryImgUpdatedVersionRemoveElements = selectAll(
        "#secondary-category-img-update-version-remove"
      );
      secondaryCategoryImgUpdatedVersionRemoveElements.forEach((el) => {
        el.addEventListener("click", (e) => {
          const secondaryCategoryImgFileInput =
    ...
    function editSecondaryCategorySubmit() {
      const editSecondaryCategoryForm = selectOne(
        "#secondary-category-edit-form"
      );

      editSecondaryCategoryForm.addEventListener("submit", async (e) => {
        e.preventDefault();

        const secondaryCategoryImgInput =
            editSecondaryCategoryForm.querySelector(
              "#secondary-category-img-input"
            ),
          secondaryCategorySelect = editSecondaryCategoryForm.querySelector(
            "#secondary-category-select"
          ),
          secondaryCategoryNameUzInput =
            editSecondaryCategoryForm.querySelector(
              "#secondary-category-name-uz"
            ),
          secondaryCategoryNameRuInput =
            editSecondaryCategoryForm.querySelector(
              "#secondary-category-name-ru"
            ),
          secondaryCategoryNameEnInput =
            editSecondaryCategoryForm.querySelector(
              "#secondary-category-name-en"
            ),
          secondaryCategoryEditSubmitBtn =
            editSecondaryCategoryForm.querySelector(".btn-primary");
        ...
        if (secondaryCategoryImgInput.files[0]) {
          formData.append(
            "sub_category_image",
            secondaryCategoryImgInput.files[0]
          );
        }
        ...
        formData.append(
          "sub_category_name_uz",
          clearText(secondaryCategoryNameUzInput.value)
        );
        formData.append(
          "sub_category_name_ru",
          clearText(secondaryCategoryNameRuInput.value)
        );
        formData.append(
          "sub_category_name_en",
          clearText(secondaryCategoryNameEnInput.value)
        );
        ...
        if (!response.ok) {
          if (
            editSecondaryCategoryForm.children[0].classList.contains(
              "alert-danger"
            )
          ) {
            editSecondaryCategoryForm.children[0].textContent =
              response.message;
          } else {
