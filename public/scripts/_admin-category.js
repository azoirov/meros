...
export default function adminCategory() {
  try {
    ...
    function editCategoryImage() {
      const categoryEditFileInputs = selectAll(
        '#category-edit-form input[type="file"]'
      );
    ...
    function categoryImgUpdatedRemove() {
      const categoryImgUpdatedVersionRemoveElements = selectAll(
        "#category-img-update-version-remove"
      );
      categoryImgUpdatedVersionRemoveElements.forEach((el) => {
        el.addEventListener("click", (e) => {
          const categoryImgFileInput =
    ...
    function editCategorySubmit() {
      const editCategoryForm = selectOne("#category-edit-form"),
        categoryImgInput = editCategoryForm.querySelector(
          "#category-img-input"
        ),
        categoryIconInput = editCategoryForm.querySelector(
          "#category-icon-input"
        ),
        categoryNameUzInput =
          editCategoryForm.querySelector("#category-name-uz"),
        categoryNameRuInput =
          editCategoryForm.querySelector("#category-name-ru"),
        categoryNameEnInput =
          editCategoryForm.querySelector("#category-name-en"),
