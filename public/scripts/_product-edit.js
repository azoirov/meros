...
export default function () {
    try {
        const productEditForm = selectOne('#product-edit-form'),
            ...
            productImagesFileInput = productEditForm.querySelector('#product-images-file-input'),
            productFeaturesWrapper = productEditForm.querySelector('.product-features'),
            productFeatureAddBtn = productEditForm.querySelector('#product-feature-add-btn'),
            ...
            productCategorySelect = productEditForm.querySelector('#product-category'),
            secondaryCategorySelect = productEditForm.querySelector("#secondary-category"),
            tertiaryCategorySelect = productEditForm.querySelector("#tertiary-category"),
            ...
            productDescriptionUz = productEditForm.querySelector('#product-description-uz'),
            productDescriptionRu = productEditForm.querySelector('#product-description-ru'),
            productDescriptionEn = productEditForm.querySelector('#product-description-en')
        ...
        productCategorySelect.addEventListener('click', async e => {
            ...
            secondaryCategorySelect.innerHTML = '<option value="" selected> - </option>'
        ...
        secondaryCategorySelect.addEventListener('click', async e => {
            ...
            response = await response.json()
            tertiaryCategorySelect.innerHTML = '<option value="" selected> - </option>'
            ...
            removeImageElements.forEach((el, index) => {
                el.addEventListener('click', e => {
                    ...
                    if (target.classList.contains('old-img')) {
                        ...
                        return deletingThumbs.push(imgURL.substring(imgURL.lastIndexOf('/') + 1))
                    }
        ...
        function productEditFormSubmit() {
            productEditForm.addEventListener('submit', async e => {
                ...
                if (response.ok) {
                    window.location.href = '/admin/products?c_page=1&p_page=30&category_slug=all'
                }
            })
        }
