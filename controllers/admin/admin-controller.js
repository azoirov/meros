        ...
        category_banners = await req.db.banners.update(
          {
            ...
            big_banner_url: big_banner_url
              ? big_banner_url
              : banner.big_banner_url,
            small_banner_1_url: small_banner_1_url
              ? small_banner_1_url
              : banner.small_banner_1_url,
            small_banner_2_url: small_banner_2_url
              ? small_banner_2_url
              : banner.small_banner_2_url,
            small_banner_3_url: small_banner_3_url
              ? small_banner_3_url
              : banner.small_banner_3_url,
            side_banner_left_url: side_banner_left_url
              ? side_banner_left_url
              : banner.side_banner_left_url,
            side_banner_right_url: side_banner_right_url
              ? side_banner_right_url
              : banner.side_banner_right_url,
          },
          {
            where: {
              category_id,
