...
module.exports = Joi.object({
    ...
    options: Joi.string()
        .required()
        .error(Error("Options must be type of JSON stringified object")),
    sub_category_id: Joi.string().error(new Error("Secondary Category id is required")),
    category_id: Joi.string().required().error(new Error("Category id is incorrect")),
